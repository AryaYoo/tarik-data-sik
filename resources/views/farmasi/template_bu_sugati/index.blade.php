...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Laporan komprehensif stok awal, penerimaan, pemberian, buffer stock, rencana pemakaian, pengadaan, dan anggaran obat.</p>
                </div>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <form action="{{ route('farmasi.template_bu_sugati.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-gray-50/50 border-b border-gray-100">
                                ...
                                <th class="px-4 py-5 text-xs font-black text-gray-400 uppercase tracking-widest text-right" title="Total barang masuk dari pesanan/penerimaan (detailpesan & pemesanan) pada periode ini">Penerimaan</th>
                                <th class="px-4 py-5 text-xs font-black text-gray-400 uppercase tracking-widest text-right" title="Total distribusi pemberian obat (detail_pemberian_obat) pada periode ini">Pemberian</th>
                                <th class="px-4 py-5 text-xs font-black text-gray-400 uppercase tracking-widest text-right" title="Stok Akhir = Stok Awal + Penerimaan - Pemberian">Stok Akhir</th>
                                <th class="px-4 py-5 text-xs font-black text-gray-400 uppercase tracking-widest text-right" title="Buffer Stock = 15% dari Pemberian">Buffer Stock 15%</th>
                                <th class="px-4 py-5 text-xs font-black text-gray-400 uppercase tracking-widest text-right" title="Rencana Pemakaian = Pemberian + Buffer Stock">Rencana Pemakaian</th>
                ...
                <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">
                            Menu <strong>Rencana Anggaran</strong> dirancang untuk kebutuhan perencanaan pengadaan inventaris farmasi (rencana pemakaian, rencana pengadaan, dan estimasi anggaran) pada suatu periode tertentu.
                        </p>
                    </div>
                        ...
                        <ul class="list-disc pl-5 space-y-4 text-sm text-gray-600">
                            <li>
                                ...
                                <div class="mt-1 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    <strong class="text-primary text-[11px]">Formula:</strong> Stok Awal + Penerimaan - Pemberian<br>
                                    <strong class="text-primary text-[11px]">Format Excel:</strong> <code class="text-red-600 font-bold">=E2+F2-G2</code>
                                </div>
                            </li>
                            <li>
                                <strong>Buffer Stock 15%:</strong> Kuantitas tambahan (15%) dari pemberian obat untuk menjaga ketahanan stok.
                                <div class="mt-1 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    <strong class="text-primary text-[11px]">Formula:</strong> Pemberian * 15%<br>
                                    <strong class="text-primary text-[11px]">Format Excel:</strong> <code class="text-red-600 font-bold">=G2*0.15</code>
                                </div>
                            </li>
                            <li>
                                <strong>Rencana Pemakaian:</strong> Kebutuhan target pemakaian obat pada periode berikutnya.
                                <div class="mt-1 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    <strong class="text-primary text-[11px]">Formula:</strong> Pemberian + Buffer Stock 15%<br>
                                    <strong class="text-primary text-[11px]">Format Excel:</strong> <code class="text-red-600 font-bold">=G2+H2</code>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="mt-1 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    ...
                                    <strong class="text-primary text-[11px]">Format Excel:</strong> <code class="text-red-600 font-bold">=IF(I2>H2, I2-H2, 0)</code>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="mt-1 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    ...
                                    <strong class="text-primary text-[11px]">Format Excel:</strong> <code class="text-red-600 font-bold">=J2*D2</code>
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <table class="w-full text-left text-xs border border-gray-100">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 text-gray-600">Transaksi pertama pada periode filter (<code class="font-mono text-[10px]">ORDER BY tanggal ASC, jam ASC LIMIT 1</code>).</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="p-2 text-gray-600">Total barang masuk dari pesanan/penerimaan pada periode terpilih.</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="p-2 text-gray-600">Total pemberian/distribusi obat pada periode terpilih.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
