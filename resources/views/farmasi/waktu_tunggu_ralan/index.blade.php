...
@section('content')
    ...
    <!-- Modal Informasi Waktu Tunggu Farmasi -->
            ...
            <div class="inline-block align-bottom bg-white rounded-3xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-gray-100">
                ...
                <div class="bg-primary px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center gap-2 text-white">
                        ...
                        <h3 class="text-lg font-black uppercase tracking-wider">Informasi Waktu Tunggu Pelayanan</h3>
                    </div>
                ...
                <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">
                            Menu **Waktu Tunggu Farmasi - Rawat Jalan** berfungsi untuk memantau durasi pelayanan penyiapan obat oleh depo farmasi rawat jalan untuk seluruh jenis penanggung jawab (BPJS, Umum, maupun asuransi lainnya).
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="list-disc pl-5 space-y-4 text-sm text-gray-600">
                            ...
                            <li>
                                <strong>Waktu Yang Dibutuhkan (Durasi):</strong> Selisih durasi antara penyerahan obat dan validasi resep.
                                <div class="mt-1.5 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                                    <strong class="text-primary text-[11px]">Formula Matematika:</strong> Waktu Tunggu = Jam Penyerahan - Jam Validasi<br>
                                    <strong class="text-primary text-[11px]">Formula Excel:</strong> <code class="text-red-600 font-bold">=F2-E2</code> (Jam Penyerahan - Jam Validasi)
                                </div>
                            </li>
                            <li>
                                <strong>Rata-rata Waktu Tunggu:</strong> Rata-rata durasi tunggu dari seluruh resep yang terkumpul pada periode tersebut.
                                <div class="mt-1.5 bg-gray-50 p-2.5 rounded-xl border border-gray-100 font-mono text-[10px] text-gray-700 shadow-inner">
                            ...
                            <table class="w-full text-left text-xs border border-gray-100">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr>
                                        ...
                                        <td class="p-2 text-gray-600">Nama jaminan/asuransi pasien (Umum, BPJS, dll).</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="p-2 font-semibold text-gray-700">Waktu Yang Dibutuhkan</td>
                                        <td class="p-2 font-mono text-primary">resep_obat</td>
