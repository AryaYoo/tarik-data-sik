...
@section('content')
    <div class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                <div>
                    <div class="flex items-center gap-2">
                        <h2 class="text-2xl font-bold text-gray-800 uppercase tracking-tighter italic">Waktu Tunggu Hasil Lab - Rawat Jalan</h2>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Monitoring durasi penyelesaian hasil pemeriksaan laboratorium pasien ralan.</p>
                </div>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            <form action="{{ route('laboratorium.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                <div>
        ...
        @if($data)
            ...
            <div class="flex items-center gap-4">
                <a href="javascript:void(0)" 
                    onclick="handleDownload('{{ route('laboratorium.export.excel', ['tgl_mulai' => $tgl_mulai, 'tgl_selesai' => $tgl_selesai, 'type' => 'ralan', 'kd_pj' => $kd_pj, 'ketepatan' => $ketepatan]) }}', 'lab-ralan-{{ $tgl_mulai }}-{{ $tgl_selesai }}.xlsx')"
                ...
                <a href="javascript:void(0)" 
                    onclick="handleDownload('{{ route('laboratorium.export.pdf', ['tgl_mulai' => $tgl_mulai, 'tgl_selesai' => $tgl_selesai, 'type' => 'ralan', 'kd_pj' => $kd_pj, 'ketepatan' => $ketepatan]) }}', 'lab-ralan-{{ $tgl_mulai }}-{{ $tgl_selesai }}.pdf')"
                    class="bg-white border border-gray-200 text-gray-700 font-bold px-6 py-3 rounded-xl hover:bg-gray-50 transition shadow-sm flex items-center gap-2 text-sm">
                ...
                <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed">
                            Menu **Waktu Tunggu Hasil Lab - Rawat Jalan** digunakan untuk mengukur dan memonitor durasi waktu penyelesaian (Turn Around Time / TAT) pemeriksaan laboratorium bagi pasien rawat jalan. Pengukuran dihitung mulai dari jam permintaan dokter hingga jam hasil laboratorium selesai divalidasi dan diunggah.
                        </p>
                    </div>
                            ...
                            <table class="w-full text-left text-xs border border-gray-100">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    <tr>
                                        ...
                                        <td class="p-2 text-gray-600">Nomor order unik permintaan lab dan nomor perawatan rawat jalan.</td>
                                    </tr>
                                    <tr>
